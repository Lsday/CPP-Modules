...
/*   Updated: 2022/01/26 13:26:34 by oronda           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
	...
	class ExecGradeTooLowException : public std::exception
	{
		public :
			virtual const char *what() const throw()
			{
				return ("\033[1;31mException\033[0m : Bureaucrat execution grade is too low to execute this form");
			}
	};
	class ExecNotSignedForm : public std::exception
	{
		public :
			virtual const char *what() const throw()
			{
				return ("\033[1;31mException\033[0m : Bureaucrat try to execute a Form that is not signed");
			}
	};
